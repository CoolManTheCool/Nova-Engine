...
nova_SwapChain::nova_SwapChain(nova_Device &deviceRef, VkExtent2D extent)
...
VkSurfaceFormatKHR nova_SwapChain::chooseSwapSurfaceFormat(
...
VkPresentModeKHR nova_SwapChain::chooseSwapPresentMode(
